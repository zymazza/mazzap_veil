    ...
    const edges = [
      {
        ...
        intersect: (start, end) => {
          const t = (bounds.minX - start[0]) / ((end[0] - start[0]) || 1e-12);
      ...
      },
      {
        ...
        intersect: (start, end) => {
          const t = (bounds.maxX - start[0]) / ((end[0] - start[0]) || 1e-12);
      ...
      },
      {
        ...
        intersect: (start, end) => {
          const t = (bounds.minY - start[1]) / ((end[1] - start[1]) || 1e-12);
      ...
      },
      {
        ...
        intersect: (start, end) => {
          const t = (bounds.maxY - start[1]) / ((end[1] - start[1]) || 1e-12);
